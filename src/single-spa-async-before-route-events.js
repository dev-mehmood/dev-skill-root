    ...
    return {
        execute: function () {
            ...
            async function reroute() {
                ...
                async function resolveNavigation(fn) {
                  
                }
                async function performAppChanges_() {
                    // 
                   ...
                   ;
                    if (typeof navigationIsCanceled === 'function') {
                        ...
                        try {
                            ...
                            ;
                            console.log(e)
                            throw "CancelNavigation if passed a function, the function must return a promise and the promise must resolve to either true or false"
                        }
                    }
                    ;
                    ...
                    return Promise.resolve().then(() => {
                        ...
                        return unmountAllPromise.catch(function (err) {
                             ...
                             * events (l throw "CancelNavigation if passed a function, the function must return a promise and the promise must resolve to either true or fals"
                        ik throw "CancelNavigation if passed a function, the function must return a promise and the promise must resolve to either true or fals"
                        e hashchange or popstate) should have been cleaned up. So it's safe
